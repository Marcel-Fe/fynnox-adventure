...
import type { GroundKind } from './themes'

// Prozedurale Boden-Texturen zur Laufzeit (Canvas) — kein externes Asset nötig.
// Übernommen aus kart-pets/src/game/textures.ts.
